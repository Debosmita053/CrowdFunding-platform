...
export default function HomePage() {
  ...
  }, [hasAnimated, categoriesAnimated]);
            ...
            {[
              {
                ...
                description: 'Lorem Ipsum velit auctor aliquet. Aenean sollic tudin, lorem is simply free text quis bibendum.'
              },
              {
              ...
              <div key={index} className="text-center">
                <div className="bg-purple-100 w-20 h-20 rounded-full mx-auto mb-8 flex items-center justify-center">
