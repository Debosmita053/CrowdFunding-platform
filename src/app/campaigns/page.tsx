...
export default function CampaignsPage() {
  ...
  const loadCampaigns = async () => {
    try {
      ...
      // Fetch campaigns from the database API
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex items-center text-base text-gray-700 mb-6">
                      ...
                      <span className="font-medium">{campaign.creator.firstName} {campaign.creator.lastName}</span>
                    </div>
                    ...
                    <div className="mb-8">
                      <div className="flex justify-between text-base mb-3">
                        ...
                        <span className="text-gray-900 font-bold">
                          {campaign.currency} {campaign.currentAmount.toLocaleString()} / {campaign.currency} {campaign.goalAmount.toLocaleString()}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center mt-3 text-base">
                        <span className="text-gray-600">
                          {Math.round(campaign.progressPercentage)}% funded
                        </span>
                    ...
                    <div className="flex items-center justify-between text-base text-gray-700 mb-8">
                      <div className="flex items-center">
                        ...
                        <span className="font-medium">{campaign.daysRemaining} days left</span>
                      </div>
                    </div>
